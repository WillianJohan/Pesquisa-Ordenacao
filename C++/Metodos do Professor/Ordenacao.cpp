...
void Ordenacao::exibe(const vector<int> &vetor) {
	long long int i;
...
vector<int> Ordenacao::selecao(vector<int> &vetor) {
...
vector<int> Ordenacao::insercao(vector<int> &vetor) {
	long long int i,j;
	int aux;
...
vector<int> Ordenacao::bolha(vector<int> &vetor) {
	long long int i;
	int aux, houveTroca;
...
vector<int> Ordenacao::agitacao(vector<int> &vetor) {
	long long int i, ini = 0, fim = vetor.size();
	int aux, houveTroca;
...
vector<int> Ordenacao::pente(vector<int> &vetor) {
...
vector<int> Ordenacao::shell(vector<int> &vetor) {
